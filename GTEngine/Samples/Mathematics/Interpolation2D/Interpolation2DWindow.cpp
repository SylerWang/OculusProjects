...
// File Version: 1.1.2 (2014/09/14)

#include "Interpolation2DWindow.h"

//----------------------------------------------------------------------------
Interpolation2DWindow::~Interpolation2DWindow()
{
    UnsubscribeCW(mMesh);
}
//----------------------------------------------------------------------------
...
void Interpolation2DWindow::OnDisplay()
{
    ...
    mEngine->Draw(mMesh);
    mEngine->Draw(8, 24, mTextColor, mName);
...
//----------------------------------------------------------------------------
bool Interpolation2DWindow::OnMouseClick(MouseButton button, MouseState state,
...
//----------------------------------------------------------------------------
bool Interpolation2DWindow::OnMouseMotion(MouseButton button, int x, int y,
...
void Interpolation2DWindow::CreateCommonObjects()
{
    ...
    mEffect.reset(new Texture2Effect(mTexture,
...
void Interpolation2DWindow::CreateBilinearMesh()
{
    ...
    SubscribeCW(mMesh, mEffect->GetPVWMatrixConstant());
    UpdateCW();
}
//----------------------------------------------------------------------------
...
{
    mVertices[0] = Vector2<float>(0.0f, 0.0f);
    mVertices[1] = Vector2<float>(0.5f, 0.0f);
    mVertices[2] = Vector2<float>(1.0f, 0.0f);
    mVertices[3] = Vector2<float>(0.0f, 0.5f);
    mVertices[4] = Vector2<float>(0.5f, 0.5f);
    mVertices[5] = Vector2<float>(0.0f, 1.0f);
