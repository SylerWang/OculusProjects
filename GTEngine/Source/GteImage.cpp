...
//----------------------------------------------------------------------------
int Image::GetDimension(int d) const
{
...
//----------------------------------------------------------------------------
size_t Image::GetOffset(int d) const
{
#if defined(GTE_IMAGICS_ASSERT_ON_INVALID_INDEX)
    if (0 <= d && d < mNumDimensions)
    {
...
//----------------------------------------------------------------------------
void Image::SetPixelMetaData(size_t i, std::string const& metadata)
{
#if defined(GTE_IMAGICS_ASSERT_ON_INVALID_INDEX)
...
//----------------------------------------------------------------------------
std::string const& Image::GetPixelMetaData(size_t i) const
{
#if defined(GTE_IMAGICS_ASSERT_ON_INVALID_INDEX)
    if (mPixelMetaData && i < mNumPixels)
    {
